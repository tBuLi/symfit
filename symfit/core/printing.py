...
NumPyPrinter._print_MatMul = _print_MatMul

def _print_Inverse(self, expr):
    return "%s(%s)" % (self._module_format('numpy.linalg.inv'),
                       self._print(expr.args[0]))
NumPyPrinter._print_Inverse = _print_Inverse

def _print_HadamardProduct(self, expr):
    return "%s*%s" % (self._print(expr.args[0]),
                      self._print(expr.args[1]))
NumPyPrinter._print_HadamardProduct = _print_HadamardProduct
...
NumPyPrinter._print_DiracDelta = _print_DiracDelta
...
NumPyPrinter._print_Idx = _print_Idx
...
NumPyPrinter._print_MatPow = _print_MatPow
