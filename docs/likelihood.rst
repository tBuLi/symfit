...
The :class:`~symfit.core.fit.Likelihood` object is a subclass of :class:`~symfit.core.fit.Maximize`. The :meth:`~symfit.core.fit.Likelihood.error_func` and :meth:`~symfit.core.fit.Likelihood.eval_jacobian` definitions have been changed to facilitate what one would expect from Likelihood fitting:
...
:meth:`~symfit.core.fit.Likelihood.eval_jacobian` gives the derivative with respect to every parameter of the log-likelihood:
